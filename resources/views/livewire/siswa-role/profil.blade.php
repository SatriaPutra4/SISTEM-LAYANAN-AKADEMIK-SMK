            ...
            <div class="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 text-center">
                <div class="relative inline-block group">
                    <div class="w-32 h-32 rounded-full overflow-hidden border-4 border-primary-50 dark:border-primary-900/20 shadow-xl mx-auto">
                        ...
                        @elseif($foto_profil)
                            <img src="{{ Storage::url($foto_profil) }}" class="w-full h-full object-cover">
                        @else
                ...
                <h3 class="mt-6 text-xl font-black text-gray-800 dark:text-white">{{ $name }}</h3>
                <p class="text-xs font-bold text-primary-600 uppercase tracking-widest mt-1">{{ $siswa->kelas->nama_kelas }} • {{ $siswa->nis }}</p>
                ...
                <div class="mt-8 pt-8 border-t border-gray-50 dark:border-gray-700 text-left space-y-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-bold text-gray-700 dark:text-gray-300">{{ $jenis_kelamin === 'L' ? 'Laki-laki' : 'Perempuan' }}</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 rounded-lg bg-gray-50 dark:bg-gray-900 flex items-center justify-center text-gray-400">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-bold text-gray-700 dark:text-gray-300">{{ $tempat_lahir ?? '-' }}, {{ $tanggal_lahir ? \Carbon\Carbon::parse($tanggal_lahir)->format('d F Y') : '-' }}</p>
                        </div>
                    </div>
                </div>
            </div>
