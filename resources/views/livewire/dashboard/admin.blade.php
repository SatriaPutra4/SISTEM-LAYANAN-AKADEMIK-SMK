...
new class extends Component {
    public function with(): array
    {
        return [
            ...
            'totalSurat' => SuratPengajuan::where('status', 'Diproses')->count(),
            'totalSppPending' => TagihanSpp::where('status', 'Menunggu Verifikasi')->count(),
            'totalPengumuman' => Pengumuman::count(),
            'pengumumans' => Pengumuman::latest()->take(5)->get(),
            'statsPembayaran' => $this->getStatsPembayaran(),
            'activities' => ActivityLog::with('user')->latest()->take(5)->get(),
        ];
    }

    private function getStatsPembayaran()
    {
        // Simple stats for chart
        return [
            'labels' => ['Jan', 'Feb', 'Mar', 'Apr', 'Mei', 'Jun'],
            'data' => [65, 59, 80, 81, 56, 55] // Dummy data for now
        ];
    }
}; ?>
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-gray-800 dark:text-white mt-1">{{ $totalSiswa }}</h3>
                </div>
            ...
            <div class="mt-4 flex items-center justify-between text-sm">
                ...
                <span class="text-gray-400">Terdaftar di {{ $totalKelas }} Kelas</span>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-gray-800 dark:text-white mt-1">{{ $totalGuru }}</h3>
                </div>
            ...
            <div class="mt-4 flex items-center justify-between text-sm">
                ...
                <span class="text-gray-400">{{ $totalJurusan }} Jurusan</span>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-gray-800 dark:text-white mt-1">{{ $totalSurat }}</h3>
                </div>
            ...
            <div class="mt-4 flex items-center justify-between text-sm">
                ...
                <a href="{{ route('surat.index') }}" class="text-primary-600 hover:underline">Lihat Detail</a>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-gray-800 dark:text-white mt-1">{{ $totalSppPending }}</h3>
                </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="p-6 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
                    ...
                    <a href="{{ route('pengumuman.index') }}" class="text-primary-600 hover:text-primary-700 text-sm font-semibold">Lihat Semua</a>
                </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                <td class="px-6 py-4">
                                    <span class="text-sm font-medium text-gray-800 dark:text-gray-200">{{ $p->judul }}</span>
                                </td>
                                <td class="px-6 py-4">
                                    <span class="px-2.5 py-0.5 text-xs font-semibold rounded-full bg-blue-100 text-blue-700 capitalize">{{ $p->target_role }}</span>
                                </td>
                                <td class="px-6 py-4">
                                    <span class="px-2.5 py-0.5 text-xs font-semibold rounded-full {{ $p->status_publish === 'Published' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700' }}">
                                        {{ $p->status_publish }}
                                    </span>
                                </td>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <a href="{{ route('siswa.index') }}" class="flex flex-col items-center justify-center p-4 rounded-xl bg-gray-50 dark:bg-gray-900 hover:bg-primary-50 dark:hover:bg-primary-900/20 group transition-all">
                    ...
                    <a href="{{ route('guru.index') }}" class="flex flex-col items-center justify-center p-4 rounded-xl bg-gray-50 dark:bg-gray-900 hover:bg-primary-50 dark:hover:bg-primary-900/20 group transition-all">
                        <div class="p-2 bg-white dark:bg-gray-800 rounded-lg shadow-sm mb-2 group-hover:text-primary-600">
                    ...
                    <a href="{{ route('pengumuman.index') }}" class="flex flex-col items-center justify-center p-4 rounded-xl bg-gray-50 dark:bg-gray-900 hover:bg-primary-50 dark:hover:bg-primary-900/20 group transition-all">
                        <div class="p-2 bg-white dark:bg-gray-800 rounded-lg shadow-sm mb-2 group-hover:text-primary-600">
                    ...
                    <a href="{{ route('spp.index') }}" class="flex flex-col items-center justify-center p-4 rounded-xl bg-gray-50 dark:bg-gray-900 hover:bg-primary-50 dark:hover:bg-primary-900/20 group transition-all">
                        <div class="p-2 bg-white dark:bg-gray-800 rounded-lg shadow-sm mb-2 group-hover:text-primary-600">
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <p class="text-sm text-gray-800 dark:text-gray-200">
                                <span class="font-bold">{{ $activity->user->name }}</span> {{ $activity->description }}
                            </p>
