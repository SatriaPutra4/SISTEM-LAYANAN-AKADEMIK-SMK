...
<div class="space-y-6">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($siswa): ?>
    <div class="relative bg-primary-800 rounded-3xl p-8 overflow-hidden shadow-xl text-white">
        <div class="relative z-10">
            <h2 class="text-3xl font-black mb-2">Halo, <?php echo e(auth()->user()->name); ?>! 👋</h2>
            <p class="text-primary-100 mb-6">Kamu terdaftar di Kelas <span class="font-bold underline"><?php echo e($siswa->kelas->nama_kelas); ?></span> Jurusan <span class="font-bold underline"><?php echo e($siswa->jurusan->nama_jurusan); ?></span></p>
            <div class="flex flex-wrap gap-4">
                <div class="bg-white/10 backdrop-blur-md px-4 py-2 rounded-xl border border-white/20">
                    ...
                    <span class="font-bold"><?php echo e($siswa->nis); ?></span>
                </div>
                <div class="bg-white/10 backdrop-blur-md px-4 py-2 rounded-xl border border-white/20">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="p-4 bg-gray-50 dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-700">
                        <div class="flex justify-between items-start mb-2">
                            <span class="px-2 py-1 bg-primary-100 text-primary-700 text-[10px] font-bold rounded-lg uppercase tracking-tighter"><?php echo e($j->hari); ?></span>
                            <span class="text-xs font-bold text-gray-400"><?php echo e(\Carbon\Carbon::parse($j->jam_mulai)->format('H:i')); ?> - <?php echo e(\Carbon\Carbon::parse($j->jam_selesai)->format('H:i')); ?></span>
                        </div>
                        <h4 class="font-bold text-gray-800 dark:text-white"><?php echo e($j->mataPelajaran->nama_mapel); ?></h4>
                        <p class="text-xs text-gray-500 mt-1"><?php echo e($j->guru->user->name); ?></p>
                    </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-gray-50 dark:divide-gray-700">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $nilais; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr>
                                <td class="py-4 text-sm font-bold text-gray-700 dark:text-gray-300"><?php echo e($n->mataPelajaran->nama_mapel); ?></td>
                                <td class="py-4 text-center text-sm font-medium"><?php echo e($n->tugas); ?></td>
                                <td class="py-4 text-center text-sm font-medium"><?php echo e($n->uts); ?></td>
                                <td class="py-4 text-center text-sm font-medium"><?php echo e($n->uas); ?></td>
                                <td class="py-4 text-center">
                                    <span class="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-lg text-xs font-black"><?php echo e($n->nilai_akhir); ?></span>
                                </td>
                            </tr>
        ...
        <div class="space-y-6">
            <div class="bg-white dark:bg-gray-800 p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700">
                ...
                <div class="space-y-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $pengumumans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-2xl border border-amber-100 dark:border-amber-800">
                        <h4 class="text-sm font-bold text-amber-800 dark:text-amber-200"><?php echo e($p->judul); ?></h4>
                        <p class="text-xs text-amber-700 dark:text-amber-300/70 mt-1 line-clamp-2"><?php echo e($p->konten); ?></p>
                        <span class="text-[10px] text-amber-500 mt-2 block"><?php echo e($p->created_at->diffForHumans()); ?></span>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
            </div>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH C:\laragon\www\SISTEM-LAYANAN-AKADEMIK-SMK\resources\views\livewire/dashboard/siswa.blade.php ENDPATH**/ ?>