<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div class="bg-white dark:bg-gray-800 p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700">
            ...
            <h4 class="text-3xl font-black text-primary-600"><?php echo e(number_format($stats['rata_rata'], 1)); ?></h4>
        </div>
        <div class="bg-white dark:bg-gray-800 p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700">
            <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Nilai Tertinggi</p>
            <h4 class="text-3xl font-black text-emerald-600"><?php echo e($stats['tertinggi']); ?></h4>
        </div>
        <div class="bg-white dark:bg-gray-800 p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700">
            <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Nilai Terendah</p>
            <h4 class="text-3xl font-black text-rose-600"><?php echo e($stats['terendah']); ?></h4>
        </div>
        <div class="bg-white dark:bg-gray-800 p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700">
            <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Total Matpel</p>
            <h4 class="text-3xl font-black text-indigo-600"><?php echo e($stats['total_mapel']); ?></h4>
        </div>
    </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-50 dark:divide-gray-700" wire:loading.class="opacity-50">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $nilais; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-900/30 transition-colors" wire:loading.remove>
                                <td class="px-8 py-5">
                                    <div class="flex flex-col">
                                        <span class="text-sm font-black text-gray-800 dark:text-white"><?php echo e($n->mataPelajaran->nama_mapel); ?></span>
                                        <span class="text-[10px] font-bold text-gray-400 uppercase tracking-tighter"><?php echo e($n->mataPelajaran->kode_mapel); ?></span>
                                    </div>
                                </td>
                                <td class="px-4 py-5 text-center text-sm font-bold text-gray-600 dark:text-gray-400"><?php echo e($n->tugas); ?></td>
                                <td class="px-4 py-5 text-center text-sm font-bold text-gray-600 dark:text-gray-400"><?php echo e($n->uts); ?></td>
                                <td class="px-4 py-5 text-center text-sm font-bold text-gray-600 dark:text-gray-400"><?php echo e($n->uas); ?></td>
                                <td class="px-8 py-5 text-center">
                                    <span class="px-4 py-1.5 rounded-xl text-xs font-black <?php echo e($n->nilai_akhir >= 75 ? 'bg-emerald-50 text-emerald-600' : 'bg-rose-50 text-rose-600'); ?>">
                                        <?php echo e($n->nilai_akhir); ?>
                ...
                <div class="h-64" x-data="{
                    ...
                    init() {
                        this.chart = new Chart(this.$refs.canvas, {
                            type: 'radar',
                            data: {
                                labels: <?php echo \Illuminate\Support\Js::from($chart_data['labels'])->toHtml() ?>,
                                datasets: [{
                                    label: 'Nilai',
                                    data: <?php echo \Illuminate\Support\Js::from($chart_data['values'])->toHtml() ?>,
...
<?php /**PATH C:\laragon\www\SISTEM-LAYANAN-AKADEMIK-SMK\resources\views/livewire/siswa-role/nilai.blade.php ENDPATH**/ ?>