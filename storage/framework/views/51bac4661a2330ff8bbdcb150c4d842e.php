...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" x-data="{ sidebarOpen: true }">
    <head>
        ...
        <title><?php echo e(config('app.name', 'SMK Tri Bhakti')); ?></title>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1162495489-0', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1162495489-1', $__key);
        ...
        <div x-data="{ 
                ...
                init() {
                    <?php if(session()->has('message')): ?>
                        this.showToast('<?php echo e(session('message')); ?>', 'success');
                    <?php endif; ?>
...
<?php /**PATH C:\laragon\www\SISTEM-LAYANAN-AKADEMIK-SMK\resources\views/layouts/app.blade.php ENDPATH**/ ?>